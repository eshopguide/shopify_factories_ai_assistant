...
FactoryBot.define do
  factory :shopify_abandoned_checkout, class: 'ShopifyAPI::AbandonedCheckout' do
    ...
    discount_codes { [FFaker::Lorem.word] }
    email { FFaker::Internet.email }
    gateway { FFaker::Payment.gateway }
    ...
    trait :with_shipping_lines do
      shipping_lines { { line1: FFaker::Lorem.word, line2: FFaker::Lorem.word, line3: FFaker::Lorem.word } }
    end

    trait :with_tax_lines do
      tax_lines { { tax1: FFaker::Number.decimal, tax2: FFaker::Number.decimal, tax3: FFaker::Number.decimal } }
    end
  end
end